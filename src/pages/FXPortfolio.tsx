...
const FXPortfolio: React.FC = () => {
  ...
  const positions = [
    { pair: "EUR/USD", risk: 0.5, pnlPercent: 1.2, position: 100000 },
    { pair: "GBP/USD", risk: 0.3, pnlPercent: -0.8, position: -50000 },
    { pair: "USD/JPY", risk: 0.7, pnlPercent: 0.5, position: 200000 },
  ];
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={metric.label}
                    className="flex justify-between items-center p-2 hover:bg-gray-800/50 rounded-lg transition-colors"
                  >
